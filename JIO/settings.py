...
SECRET_KEY = 'django-insecure-^o6j+1ixxg^or#&%_*5b31flx@c3f%uw&hhg#tlzhv0#jmy@*q'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'jio_app' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Google Maps API Key
# Obtener tu API key en: https://console.cloud.google.com/google/maps-apis
